...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/co')) {
            if (0 === strpos($pathinfo, '/configure/advanced/system_information')) {
                // admin_system_information
                if ($pathinfo === '/configure/advanced/system_information') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_admin_system_information;
                    }

                    return array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\AdvancedParameters\\SystemInformationController::indexAction',  '_legacy_controller' => 'AdminInformation',  '_route' => 'admin_system_information',);
                }
                not_admin_system_information:

                // admin_system_information_check_files
                if ($pathinfo === '/configure/advanced/system_information/files' && $request->isXmlHttpRequest()) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_admin_system_information_check_files;
                    }

                    return array (  '_controller' => 'PrestaShopBundle\\Controller\\Admin\\AdvancedParameters\\SystemInformationController::displayCheckFilesAction',  '_legacy_controller' => 'AdminInformation',  '_route' => 'admin_system_information_check_files',);
                }
        ...
        if (0 === strpos($pathinfo, '/api')) {
            if (0 === strpos($pathinfo, '/api/stock')) {
                ...
                if ($pathinfo === '/api/stock/export') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_api_stock_list_products_export;
                    }

                    return array (  '_controller' => 'prestashop.core.api.stock.controller:listProductsExportAction',  '_route' => 'api_stock_list_products_export',);
                }
